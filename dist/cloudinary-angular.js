...
(function (cloudinary) {
    /* @ngInject */
    function clBackgroundImage(Cloudinary, $log) {
        return {
            restrict: 'A',
            scope: {},
            priority: 99,
    ...
    clBackgroundImage.$inject = ["Cloudinary", "$log"];
    angular
        .module('cloudinary')
...
(function (cloudinary) {
    ...
    cloudinary.cloudinaryAttr = cloudinaryAttr;
    ;
    ...
    cloudinary.cloudinary_url = cloudinary_url;
})(cloudinary || (cloudinary = {}));
